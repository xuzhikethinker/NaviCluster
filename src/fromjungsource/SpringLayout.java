...
public class SpringLayout<V, E> extends AbstractLayout<V,E> implements IterativeContext {
    ...
    public SpringLayout(Graph<V,E> g) {
        this(g, new ConstantTransformer(30+85));
    }
...
//                    }
    ...
    protected double calcForceMultiplier(E edge){
...
//            System.out.println("edgeweight "+edgeweight);
            double value = ((double) (edgeweight) / (maxWeight - minWeight))*0.5+1;

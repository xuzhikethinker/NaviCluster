 ...
 *
 * Modified by Thanet Praneenararat, the University of Tokyo
 */
 ...
 */
public class ModSpringLayout<V, E> extends AbstractLayout<V, E> implements IterativeContext {
    ...
    public ModSpringLayout(Graph<V, E> g) {
     ...
     */
    public ModSpringLayout(Graph<V, E> g, Transformer<E, Integer> length_function) {
        super(g);

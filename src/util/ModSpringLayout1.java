 ...
 */
public class ModSpringLayout1<V, E> extends AbstractLayout<V, E> implements IterativeContext {
     ...
     * length function.
     */
    public ModSpringLayout1(Graph<V, E> g) {
     ...
     *            the length function
     */
    public ModSpringLayout1(Graph<V, E> g, Transformer<E, Integer> f) {
        super(g);
    ...
    /* ------------------------- */
    protected void calcEdgeLength(SpringEdgeData<E> sed, Transformer<E, Integer> f) {
//        sed.length = f.getLength(sed.e);
        sed.length = f.transform(sed.e);
    }
...
//    	this.fireStateChanged();
     ...
     * @author danyelf
     */
    public static final class UnitLengthFunction<E> implements Transformer<E, Double> {
...
//        }
    ...
    public static final Transformer UNITLENGTHFUNCTION = new UnitLengthFunction(
            30);
...
//		initialize();
    ...
    public Transformer<E,Integer> getLengthFunction() {
        return lengthFunction;
    }

    public void setLengthFunction(Transformer<E,Integer> lengthFunction) {
